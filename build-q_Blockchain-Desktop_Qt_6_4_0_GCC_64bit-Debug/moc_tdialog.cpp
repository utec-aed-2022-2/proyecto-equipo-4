...
#include <memory>
#include "../q_Blockchain/tdialog.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_TDialog_t qt_meta_stringdata_TDialog = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_TDialog[] = {
...
Q_CONSTINIT const QMetaObject TDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_TDialog.offsetsAndSizes,
    qt_meta_data_TDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_TDialog_t,
        // Q_OBJECT / Q_GADGET
